...
function App() {
  return (
    <div className="bg-gray-100 min-h-screen">
      {/* Header Section */}
      <header className="nav-header-bg-white shadow-md">
        <div className="nav-header-container mx-auto flex items-center justify-between px-4 py-2 border-b">
          <div className="nav-header-container flex items-center space-x-4">
            {/* LinkedIn Logo */}
            <div className="nav-headerLogo-linkedin-logo">
            ...
            {/* Search Bar */}
            <div className="nav-search-bar flex items-center space-x-2">
              <FontAwesomeIcon icon="search" className="text-gray-600" />
              <input type="text" className="nav-search-text border-none focus:outline-none" placeholder="Search" />
            </div>
          </div>

          {/* Header Navigation Icons */}
          <div className="nav-icon flex items-center space-x-6">
            <NavItem icon="home" label="Home" color="#333" />
            ...
            <div className="relative flex flex-col items-center">
              ...
              <span className="nav-icon-notification text-xs text-gray-600">Notifications</span>
              <span className="nav-icon-notification-text absolute top-0 right-0 bg-red-600 text-white text-xs rounded-full px-1">25</span>
            </div>
            {/* Profile Icon */}
            <div className="nav-icon-profile flex flex-col items-center">
            <img alt="Profile Picture" className="h-10 w-10 rounded-full"  src="https://media.licdn.com/dms/image/v2/D4D03AQHxqg0yT1EXiA/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1713555361464?e=1732752000&amp;v=beta&amp;t=4JsZnh_qf1aroB8ZKlOT1467BXqED3r8gFUiu_wxkaI" loading="lazy"  id="ember329"  />
              <span className="nav-icon-me text-xs text-gray-600">Me</span>
            </div>
      ...
      {/* Main Body Content */}
      <div className="main-container mx-auto flex mt-6 space-x-6">
        {/* Sidebar */}
        <aside className="main-aside w-1/4 bg-white p-4 rounded-lg shadow-md">
          <h2 className="main-h2 text-xl font-semibold mb-4">Your Profile</h2>
          <div className="main-profile flex items-center space-x-3">
          <img alt="Profile Picture" className="h-16 w-16 rounded-full"  src="https://media.licdn.com/dms/image/v2/D4D03AQHxqg0yT1EXiA/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1713555361464?e=1732752000&amp;v=beta&amp;t=4JsZnh_qf1aroB8ZKlOT1467BXqED3r8gFUiu_wxkaI" loading="lazy" height="64" id="ember329"  />
            <div>
              <h4 className="main-h4 text-md font-semibold">Ojo Damilare</h4>
              <p className="main-bio text-sm text-gray-500">Web 3 Researcher, Frontend Dev</p>
            </div>
          </div>
          <div className="main-button mt-4">
            <button className="main-button-btn w-full py-2 bg-blue-600 text-white rounded-md">View Profile</button>
          </div>
        </aside>

        {/* Feed Section */}
        <main className="main-feed-container w-2/4">
          {/* Post 1 */}
          <FeedPost
        ...
        <aside className="right-side-container w-1/4 bg-white p-4 rounded-lg shadow-md">
          <h2 className="right-h2 text-xl font-semibold mb-4">Jobs for You</h2>
          <div>
            <p className="right-p text-sm">Web Developer at XYZ Corp.</p>
            <button className="right-p-btn text-blue-600">Apply Now</button>
          </div>
          <div className="right-p mt-4">
            <p className="right-p-ui/ux text-sm">UI/UX Designer at ABC Inc.</p>
            <button className="right-p-btn text-blue-600">Apply Now</button>
          </div>
        </aside>
      </div>
